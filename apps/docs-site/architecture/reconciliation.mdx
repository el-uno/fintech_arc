---
title: "Reconciliation: Balanced Books Are Not Correct Books"
sidebarTitle: "Reconciliation"
description: "Three-way reconciliation against bank statements and chain history, break kinds and cases, and the float-position report that answers what the trial balance cannot."
icon: "scale-unbalanced"
keywords: ["three-way reconciliation", "reconciliation breaks", "float position", "solvency reporting", "corridor P&L", "payment operations runbook"]
---
...
- [Reconciliation break](https://github.com/el-uno/fintech_arc/blob/main/docs/runbooks/reconciliation-break.md) — triage by break kind, three resolutions, closing criteria
- [Stuck settlement](https://github.com/el-uno/fintech_arc/blob/main/docs/runbooks/stuck-settlement.md) — mempool, reverts, finality depths per chain
- [Chain reorg](https://github.com/el-uno/fintech_arc/blob/main/docs/runbooks/chain-reorg.md) — expected depths, and the one question that matters
