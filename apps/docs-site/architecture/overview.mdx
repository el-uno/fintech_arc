---
title: "Arc Architecture Overview: Six Contexts, One Deployable"
...
icon: 'layer-group'
keywords: ["modular monolith", "bounded contexts", "event bus", "payments architecture", "domain-driven design"]
---
...
| **Risk & Compliance** | KYC/KYB tiering, sanctions screening, AML rules, review queues                                | Built       |
| **Platform**          | Auth, gateway, webhook delivery, observability, secrets, jobs                                 | Built       |
| **Partner Platform**  | Partner onboarding, sandbox, Last Mile API, usage and billing                                 | Built       |
