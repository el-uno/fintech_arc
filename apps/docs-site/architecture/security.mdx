---
title: "Platform and Security: Signing, Idempotency, Secrets"
sidebarTitle: "Platform"
description: "OAuth2 plus HMAC request signing, idempotency that distinguishes a retry from a conflict, signed webhooks, envelope encryption, and redaction on the logging path."
icon: "shield-halved"
keywords: ["HMAC request signing", "idempotency key", "webhook signature verification", "envelope encryption", "secret redaction", "rate limiting"]
---
