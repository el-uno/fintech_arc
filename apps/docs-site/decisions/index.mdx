...
<CardGroup cols={2}>
  ...
  <Card title="0003 · Double-entry, enforced by the database" icon="scale-balanced" href="/decisions/0003-double-entry-ledger">
    Balances derived from entries, entries append-only, and the balance rule enforced in Postgres as well as in code.
  </Card>
  <Card title="0004 · Chain-agnostic driver" icon="link" href="/decisions/0004-chain-abstraction">
  ...
  <Card title="0006 · Saga over two-phase commit" icon="diagram-project" href="/decisions/0006-saga-over-two-phase-commit">
