...
description: "Four curated routes through this site: domain understanding, system architecture, real-world scenarios, or interview prep. Pick the one that fits your goal."
icon: 'compass'
keywords: ["documentation guide", "fintech learning path", "payments engineering"]
---
